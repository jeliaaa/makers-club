...
const MainHero = () => {
    const socials = [
        ...
        { to: 'https://www.tiktok.com/@makersclubhere', img: tiktok }
    ]
    return (
        <div className='relative pt-[11dvh] px-10 flex w-full h-dvh bg-cover bg-no-repeat bg-center' style={{ backgroundImage: `url(${mainHero})` }}>
            <div className='w-full lg:w-1/2'>
                <h1 className="[text-shadow:_0_2px_4px_rgb(0_0_0_/_0.8)] text-white mt-40 md:mt-0 text-7xl uppercase font-bold">Welcome <br /> to the<br /> makers club</h1>
